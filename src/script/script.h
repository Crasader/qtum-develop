...
//    CScript& operator<<(int32_t b) { return push_int32(b); }
    ...
    bool HasOpSSTX() const
    {
    	return *begin() == OP_SSTX;
    }

    bool HasOpSSGEN() const
	{
		return *begin() == OP_SSGEN;
	}

    bool HasOpSSRTX() const
	{
		return *begin() == OP_SSRTX;
	}

    bool HasOpSSTXCHANGE() const
	{
		return *begin() == OP_SSTXCHANGE;
	}
    /////////////////////////////////////////
